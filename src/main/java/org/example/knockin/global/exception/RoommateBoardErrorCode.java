...
public enum RoommateBoardErrorCode implements ErrorCode {
    ...
    ROOMMATE_BOARD_FILE_COUNT_EXCEEDED(2002, HttpStatus.BAD_REQUEST, "게시글당 최대 "+ RoommateBoard.IMAGE_MAXIMUM + "장까지 업로드할 수 있습니다."),
    ROOMMATE_BOARD_FILE_COUNT_THUMBNAIL_EXCEEDED(2003, HttpStatus.BAD_REQUEST, "썸네일은 최대 " + RoommateBoard.THUMBNAIL_MAXIMUM + "장 입니다."),
